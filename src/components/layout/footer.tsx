...
export default function Footer() {
  return (
    <footer className="w-full border-t border-border bg-bg pt-16 pb-12 mt-auto relative overflow-hidden">
      {/* Subtle bottom glow */}
      <div
        className="absolute bottom-0 left-1/2 -translate-x-1/2 h-44 w-80 rounded-full bg-primary/5 blur-[100px] pointer-events-none"
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-border">
          ...
          <div className="md:col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-2.5 group">
              <div
                className="flex h-7 w-7 items-center justify-center rounded-pill bg-primary/10 text-primary transition-all duration-300 group-hover:scale-105"
              >
            ...
            <p className="text-xs sm:text-sm text-muted max-w-xs leading-relaxed">
              A curated library of beautiful, interactive React and Tailwind CSS backgrounds. Open-source, production-ready, and copy-pasteable.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted">Resources</h4>
            <ul className="space-y-2 text-xs text-muted-2">
              <li>
                <a href="/#how-to-use" className="hover:text-fg transition-colors">
                  How to Use
                </a>
              </li>
              <li>
